﻿﻿create database phonestoredn;
--drop database phonestoredn;
--USE master;
...
('SP001', N'iPhone 13', '3240mAh', 'iOS', '12MP', '12MP + 12MP', 'USA', null, 'On', 'TH001'),
('SP002', N'Galaxy S22', '3700mAh', 'Android', '10MP', '50MP + 12MP', 'Korea', null, 'On', 'TH002'),
('SP003', N'Redmi Note 11', '5000mAh', 'Android', '13MP', '50MP + 8MP', 'China', null, 'Off', 'TH003'),
('SP004', N'Find X5', '4800mAh', 'Android', '32MP', '50MP + 50MP', 'China', null, 'On', 'TH004'),
('SP005', N'Vivo X70', '4400mAh', 'Android', '32MP', '50MP + 12MP', 'China', null, 'Off', 'TH005');
...
('PBSP002', N'Trắng', '12GB', '256GB', 25000000.00, 9, 'On', 'SP002'),
('PBSP003', N'Xanh', '8GB', '128GB', 18000000.00, 8, 'On', 'SP003'),
('PBSP004', N'Vàng', '6GB', '64GB', 12000000.00, 7, 'On', 'SP004'),
('PBSP005', N'Tím', '8GB', '256GB', 22000000.00, 6, 'On', 'SP005');
INSERT INTO PBSP (maPBSP, mauSac, ram, rom, giaBan, soLuong, trangThai, maSP) 
VALUES
('PBSP006', N'Xám', '12GB', '512GB', 28000000.00, 11, 'On', 'SP002'),
('PBSP007', N'Xanh dương', '6GB', '128GB', 16000000.00, 12, 'On', 'SP003'),
('PBSP008', N'Hồng', '8GB', '256GB', 21000000.00, 13, 'On', 'SP004'),
('PBSP009', N'Bạc', '12GB', '1TB', 32000000.00, 14, 'On', 'SP002'),
('PBSP010', N'Đỏ', '8GB', '128GB', 19000000.00, 15, 'On', 'SP005'),
('PBSP011', N'Xanh lá', '6GB', '64GB', 14000000.00, 16, 'On', 'SP001');
...
VALUES 
('NV001', N'Đặng Văn K', '1994-07-07', N'Nam', N'987 Phan Xích Long, TP.HCM', '0951234567', 'dangvank@example.com', NULL, 'passk303', 'On', 'CV000'),
('NV002', N'Huỳnh Thị L', '1991-10-25', N'Nữ', N'246 Hoàng Hoa Thám, Hà Nội', '0962345678', 'huynhthil@example.com', NULL, 'passl404', 'On', 'CV003'),
('NV003', N'Tô Văn M', '1998-01-30', N'Nam', N'135 Nguyễn Thượng Hiền, Đà Nẵng', '0973456789', 'tovanm@example.com', NULL, 'passm505', 'On', 'CV002'),
('NV004', N'Trịnh Thị N', '1995-05-20', N'Nữ', N'753 Lý Thường Kiệt, Cần Thơ', '0984567890', 'trinhthin@example.com', NULL, 'passn606', 'On', 'CV003'),
('NV005', N'Ngô Văn O', '1992-11-11', N'Nam', N'852 Ba Tháng Hai, Hải Phòng', '0995678901', 'ngovano@example.com', NULL, 'passo707', 'On', 'CV001');
...
VALUES 
('PN001', '2024-03-23', 6000000, N'Đã xác nhận', 'NV005', 'NCC002'),
('PN002', '2024-03-26', 7500000, N'Chờ xác nhận', 'NV006', 'NCC001'),
('PN003', '2024-03-29', 9000000, N'Chờ xác nhận', 'NV007', 'NCC002'),
('PN004', '2024-04-07', 8500000, N'Đã nhận hàng', 'NV008', 'NCC005');

-- Chèn dữ liệu vào bảng CTPN
INSERT INTO CTPN (soLuong, giaNhap, maPN, maPBSP) 
VALUES 
-- PN001 có 3 chi tiết
(7, 870000, 'PN005', 'PBSP013'),
(11, 860000, 'PN005', 'PBSP014'),
(13, 880000, 'PN005', 'PBSP015'),

-- PN002 có 3 chi tiết
(10, 600000, 'PN006', 'PBSP016'),
(5, 620000, 'PN006', 'PBSP017'),
(8, 610000, 'PN006', 'PBSP018'),

-- PN003 có 3 chi tiết
(4, 700000, 'PN007', 'PBSP019'),
(6, 720000, 'PN007', 'PBSP020'),
(10, 710000, 'PN007', 'PBSP021'),

-- PN004 có 3 chi tiết
(9, 800000, 'PN008', 'PBSP022'),
(11, 820000, 'PN008', 'PBSP023'),
(7, 810000, 'PN008', 'PBSP024');

-- Chèn dữ liệu vào bảng PHIEUXUAT
INSERT INTO PHIEUXUAT (maPX, ngayTao, diaChi, tongTien, httt, trangThai, maNV, maKH) 
VALUES 
('PX001', '2024-04-20', N'33 Võ Văn Kiệt, Cần Thơ', 8300000, N'Chuyển khoản', N'Đã nhận hàng', 'NV005', 'KH005'),
('PX002', '2024-04-25', N'15 Trần Hưng Đạo, TP.HCM', 9100000, N'Tiền mặt', N'Chờ xác nhận', 'NV006', 'KH001'),
('PX003', '2024-04-30', N'22 Lê Văn Sỹ, TP.HCM', 6700000, N'Chuyển khoản', N'Chờ xác nhận', 'NV007', 'KH002'),
('PX004', '2024-05-01', N'88 Nguyễn Huệ, Đà Nẵng', 5400000, N'Chuyển khoản', N'Đã xác nhận', 'NV008', 'KH004');
...
('BCC0325NV001', 3, 2024, 22, 0, 0, 0, 2.0, 0, 1.0, 'NV001'),
('BCC0325NV002', 3, 2024, 22, 0, 0, 0, 2.0, 0, 0, 'NV002'),
('BCC0325NV003', 3, 2024, 21, 0, 1, 0, 0, 0, 0, 'NV003'),
('BCC0325NV004', 3, 2024, 21, 1, 0, 0, 0, 0, 0, 'NV004'),
('BCC0325NV005', 3, 2024, 22, 0, 0, 0, 1.5, 0, 0, 'NV005');
...
('CT032025NV001', '2025-03-01', N'Tăng ca ngày chủ nhật', null, 'BCC0325NV001', 1.0),
('CT032025NV001', '2025-03-03', N'Tăng ca ngày thường', null, 'BCC0325NV001', 2.0),
('CT032025NV002', '2025-03-02', N'Tăng ca thường', null, 'BCC0325NV002', 2.0),
('CT032025NV003', '2025-03-03', N'Nghỉ phép có lương', N'Nghỉ lễ', 'BCC0325NV003', 0),
