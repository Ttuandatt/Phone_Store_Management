﻿﻿create database phonestorehcm;
--drop database phonestorehcm;
--USE master;
...
VALUES
('PBSP001', N'Trắng', '8GB', '128GB', 20000000.00, 10, 'on', 'SP001'),
('PBSP002', N'Đen', '12GB', '256GB', 25000000.00, 8, 'on', 'SP002'),
('PBSP003', N'Đỏ', '8GB', '128GB', 18000000.00, 15, 'on', 'SP003'),
('PBSP004', N'Xám', '6GB', '64GB', 12000000.00, 12, 'on', 'SP004'),
('PBSP005', N'Hồng', '8GB', '256GB', 22000000.00, 7, 'on', 'SP005');
INSERT INTO PBSP (maPBSP, mauSac, ram, rom, giaBan, soLuong, trangThai, maSP) 
VALUES
...
VALUES 
('NV001', N'Nguyễn Văn A', '1990-05-12', N'Nam', N'123 Lê Lợi, TP.HCM', '0901234567', 'nguyenvana@example.com', NULL, '123456', 'on', 'CV001'),
('NV002', N'Trần Thị B', '1995-08-22', N'Nữ', N'456 Hai Bà Trưng, Hà Nội', '0912345678', 'tranthib@example.com', NULL, 'abcdef', 'on', 'CV002'),
('NV003', N'Phạm Văn C', '1988-11-03', N'Nam', N'789 Nguyễn Huệ, Đà Nẵng', '0923456789', 'phamvanc@example.com', NULL, 'password', 'off', 'CV003'),
('NV004', N'Lê Thị D', '1992-03-15', N'Nữ', N'321 Lạc Long Quân, Cần Thơ', '0934567890', 'lethid@example.com', NULL, 'letidpass', 'on', 'CV002'),
('NV005', N'Hoàng Văn E', '1998-07-29', N'Nam', N'654 Trần Hưng Đạo, Hải Phòng', '0945678901', 'hoangvane@example.com', NULL, 'hoangepass', 'off', 'CV001');
...
VALUES 
('PN001', '2024-03-01', 5000000, N'Đã nhận hàng', 'NV001', 'NCC001'),
('PN002', '2024-03-05', 3200000, N'Đã nhận hàng', 'NV002', 'NCC002'),
('PN003', '2024-03-10', 4500000, N'Đã nhận hàng', 'NV003', 'NCC003'),
('PN004', '2024-03-15', 2800000, N'Đã xác nhận', 'NV004', 'NCC001'),
('PN005', '2024-03-20', 6000000, N'Đã xác nhận', 'NV005', 'NCC002');
...
VALUES 
('PX001', '2024-03-01', N'12 Nguyễn Trãi, Hà Nội', 7500000, N'Tiền mặt', N'Đã xác nhận', 'NV001', 'KH001'),
('PX002', '2024-03-05', N'45 Lê Lợi, TP.HCM', 4200000, N'Chuyển khoản', N'Đã xác nhận', 'NV002', 'KH002'),
('PX003', '2024-03-10', N'78 Trần Phú, Đà Nẵng', 5200000, N'Tiền mặt', N'Đã xác nhận', 'NV003', 'KH003'),
('PX004', '2024-03-15', N'90 Phạm Văn Đồng, Hải Phòng', 6100000, N'Thanh toán khi nhận hàng', N'Đã nhận hàng', 'NV004', 'KH004'),
('PX005', '2024-03-20', N'33 Võ Văn Kiệt, Cần Thơ', 8300000, N'Chuyển khoản', N'Đã nhận hàng', 'NV005', 'KH005');
...
('BCC0325NV001', 3, 2024, 22, 0, 0, 0, 0, 3.0, 0, 'NV001'),
('BCC0325NV002', 3, 2024, 22, 0, 0, 0, 0, 0, 2.0, 'NV002'),
...
('CT032025NV003', '2025-03-03', N'Nghỉ phép có lương', N'Nghỉ đám cưới con gái', 'BCC0325NV003', 0),
