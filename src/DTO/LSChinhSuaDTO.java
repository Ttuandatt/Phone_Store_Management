...
public class LSChinhSuaDTO {
    ...
    public LSChinhSuaDTO(String maNguoiChinhSua, String maNguoiBiChinhSua, LocalDateTime thoiGian, String giaTriCu, String giaTriMoi) {
