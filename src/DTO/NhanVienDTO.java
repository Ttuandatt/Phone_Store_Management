...
public class NhanVienDTO {
    ...
    private String chucVu;       // Chức vụ (Nhân viên, Quản lý,...)
    ...
    private String maCV;		 // Khóa ngoại mã chức vụ
	...
	public NhanVienDTO(String maNV, String hoTen, Date ngaySinh, String gioiTinh, String diaChi, String soDienThoai, String email, String chucVu, String matKhau, byte[] hinhAnh, String trangThai, String maCV, String noiLamViec) {
		this.maNV = maNV;
		this.hoTen = hoTen;
