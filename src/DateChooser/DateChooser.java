...
public final class DateChooser extends JPanel {
    ...
    private NgayThangNamDTO selectedDate = new NgayThangNamDTO();
...
//        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/img/arrow_r.png"))); // NOI18N
...
//        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/img/arrow_l.png"))); // NOI18N
    ...
    public NgayThangNamDTO getNgayThangNamDTO() {
        return selectedDate;
    }

    public void setSelectedDate(NgayThangNamDTO selectedDate) {
