...
public class DSBangLuongGUI extends JPanel{
    ...
    JLabel lb_thuong, lb_khoanTru, lb_bhxh, lb_bhyt, lb_bhtn, lb_thue, lb_tamUng, lb_phuCap, lb_pcAnTrua, lb_pcDiChuyen, lb_heSo;
...
//==================================================== TOP PANEL =============================================================================================//
        ...
        btnDetail.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                } else JOptionPane.showMessageDialog(null, "Vui lòng chọn một nhân viên!", "Thông báo", JOptionPane.WARNING_MESSAGE);  
            }
        });
...
/////////////////////////        
    ...
    private void btnLuuSuaBangLuong() {
        ...
        JTextField[] fields = {tf_heSo, tf_thuong, tf_bhxh, tf_bhyt, tf_bhtn, tf_thue, tf_tamUng, tf_pcAnTrua, tf_pcDiChuyen };
        String[] fieldNames = {"Hệ số lương", "Thưởng", "BHXH", "BHYT", "BHTN", "Thuế TNCN", "Tạm ứng", "Phụ cấp ăn trưa", "Phụ cấp di chuyển" };
    ...
    private void TaoBangLuongNhanVienMoiDialog() {
        JDialog bangLuongNVMoi = new JDialog((JFrame) SwingUtilities.getWindowAncestor(this), "Thêm bảng lương cho nhân viên mới", true);
        ...
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (thang.equals("Tháng") || nam.equals("Năm") || txtHeSo.getText().trim().isEmpty()) {
                    JOptionPane.showMessageDialog(null, "Vui lòng chọn tháng, năm và nhập hệ số lương!", "Thiếu thông tin", JOptionPane.WARNING_MESSAGE);
                    return;
                }
                ...
                try {
                    ...
                    if (heSo <= 0) {
                        JOptionPane.showMessageDialog(null, "Hệ số lương phải lớn hơn 0!", "Giá trị không hợp lệ", JOptionPane.WARNING_MESSAGE);
                        return;
                    }
                } catch (NumberFormatException ex) {
                    JOptionPane.showMessageDialog(null, "Hệ số lương phải là số!", "Lỗi định dạng", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (kq > 0)
                    JOptionPane.showMessageDialog(null, "Tạo bảng lương cho nhân viên mới thành công!", "Thành công", JOptionPane.INFORMATION_MESSAGE);
                else
