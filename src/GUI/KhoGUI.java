...
ButtonGroup group;
    ...
    topLeftPanel.add(rbOff);
        ...
        txtQuanLyKho.setEditable(false);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String quanLy = txtQuanLyKho.getText().trim(); // Nếu cần dùng
...
JOptionPane.showMessageDialog(null, result);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        txtDiaChi.setText("");
        txtSdt.setText("");
        txtQuanLyKho.setText(""); // Nếu cần thiết
  ...
  private void loadDanhSachNhanVienTheoKho(String tenKho) {
    ...
    if (kho != null) {
        ...
        if (kho.getTrangThai().equals("1")) {  // Kiểm tra nếu trạng thái là "1"
            rbOn.setSelected(true);
        } else {
            rbOff.setSelected(true);
        }
            String maNVQuanLy = khoBUS.getMaNVQuanLyKho(kho.getMaKho());
        txtQuanLyKho.setText(maNVQuanLy != null ? maNVQuanLy : "");
    }
    ...
    javax.swing.SwingUtilities.invokeLater(new Runnable() {
        public void run() {
            JFrame frame = new JFrame("Quản lý kho");
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            frame.setSize(1000, 600); // bạn có thể chỉnh kích thước nếu muốn
            frame.setLocationRelativeTo(null); // căn giữa màn hình
            frame.setContentPane(new KhoGUI());
