...
public class PersonalInformationController {
    ...
    public void setBangLuong(ArrayList<BangLuongDTO> arrBangLuong) {
        ...
        tv_luongthucte.setCellValueFactory(cellData -> {
            ...
            luongThucTe = (cellData.getValue().getLuongCB()* cellData.getValue().getHeSo())/24 * bcc.getSoNgayLam();
        ...
        tv_luongOT.setCellValueFactory(cellData -> {
            ...
            String mabcc= dto.getMaLuong().replaceFirst("BL", "CC");
            BangChamCongDTO bcc = bccBUS.selectById(mabcc);
            double t = (cellData.getValue().getLuongCB()* dto.getHeSo())/(24*8);
            luongOT = t*bcc.getSoGioOTNgayThuong() + t*2*bcc.getSoGioOTCN() + t*3*bcc.getSoGioOTNgayLe();
        ...
        tv_phucap.setCellValueFactory(cellData -> {
            tongPhuCap = cellData.getValue().getPhuCapAnTrua() + cellData.getValue().getPhuCapDiLai();
        ...
        tv_cackhoantru.setCellValueFactory(cellData -> {
            tongTru = cellData.getValue().getBhxh()
        ...
        tv_thucnhan.setCellValueFactory(cellData -> {
            double thucNhan = luongThucTe + luongOT + tongPhuCap + cellData.getValue().getThuong() - tongTru;
