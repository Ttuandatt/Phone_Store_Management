...
//		searchLeftPanel.add(dateChooser);
		...
		// ======================= quantityLeftPanel =======================//
		JLabel quantityLabel = new JLabel("Nhâp số lượng: ");
...
//		optionRightPanel.setBackground(Color.decode("#785589"));
		...
		JLabel slipIdLabel, warehouseIdLabel, creatorIdLabel, customerLabel, dateLabel;
		...
		customerLabel = new JLabel("Mã khách hàng:");
		customerLabel.setBounds(10, 100, 100, 20);
		informationRightPanel.add(customerLabel);


		dateLabel = new JLabel("Thời gian:");
		dateLabel.setBounds(340, 10, 100, 20);
		informationRightPanel.add(dateLabel);

		JTextField slipIdTF, warehouseIdTF, creatorIdTF, customerIdTF, dateTF;
		...
		customerIdTF.setBounds(110, 100, 100, 20);
		informationRightPanel.add(customerIdTF);
		
		dateTF = new JTextField();
		dateTF.setEditable(false);
		dateTF.setEnabled(false);
		dateTF.setBounds(410, 10, 100, 20);
		...
		btnFixQuantity.setBounds(15, 20, 110, 25);
		...
		btnImport = new ShadowButton("Xuất hàng");
